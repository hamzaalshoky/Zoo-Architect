...
@OnlyIn(Dist.CLIENT)
public class TamarinDiaperLayer<E extends GoldenTamarinEntity> extends GeoRenderLayer<E> {

    private static final ResourceLocation LAYER = new ResourceLocation(ZooArchitect.MOD_ID, "textures/entity/golden_tamarin/golden_tamarin_diapers.png");

    public TamarinDiaperLayer(GeoRenderer<GoldenTamarinEntity> entityRendererIn) {
