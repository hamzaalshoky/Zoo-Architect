...
import net.itshamza.za.entity.custom.ITargetsDroppedItems;
...
public class CreatureAITargetItems<T extends ItemEntity> extends TargetGoal {
    ...
    public void tick() {
        ...
        if(targetEntity != null && this.mob.hasLineOfSight(targetEntity) && this.mob.getBbWidth() > 2D && !this.mob.isFallFlying()){
