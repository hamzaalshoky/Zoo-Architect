...
public class PlayDeadGoal<T extends LivingEntity> extends Goal {
     ...
     */
    public PlayDeadGoal(OpossumEntity pMob, Class<T> pEntityClassToAvoid, float pMaxDistance, double pWalkSpeedModifier, double pSprintSpeedModifier) {
     ...
     * Goal that helps mobs avoid mobs of a specific class
     */
    public PlayDeadGoal(OpossumEntity pMob, Class<T> pEntityClassToAvoid, float pMaxDistance, double pWalkSpeedModifier, double pSprintSpeedModifier, Predicate<LivingEntity> pPredicateOnAvoidEntity) {
