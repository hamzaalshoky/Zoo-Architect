...
public class PoisonTwoMeleeAttackGoal extends Goal {
    ...
    public PoisonTwoMeleeAttackGoal(PathfinderMob p_25552_, double p_25553_, boolean p_25554_) {
        this.mob = p_25552_;
    ...
    protected void checkAndPerformAttack(LivingEntity p_25557_, double p_25558_) {
        ...
        if (p_25558_ <= d0 && this.ticksUntilNextAttack <= 0) {
            ...
            if(!p_25557_.isBlocking()){
                p_25557_.addEffect(new MobEffectInstance(MobEffects.POISON, 500, 1), this.mob);
            }
