...
public class RattlesnakeEntity extends Animal implements GeoEntity {
    ...
    private PlayState predicate(software.bernie.geckolib.core.animation.AnimationState animationState) {
        ...
        if(this.isRattling()) {
            animationState.getController().setAnimation(RawAnimation.begin().then("rattle", Animation.LoopType.LOOP));
            return PlayState.CONTINUE;
        }
