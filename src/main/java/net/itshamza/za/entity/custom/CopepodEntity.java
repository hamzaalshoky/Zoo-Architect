...
public class CopepodEntity extends AbstractSchoolingFish implements IAnimatable {

    private AnimationFactory factory = new AnimationFactory(this);
    private static final EntityDataAccessor<Integer> MOISTNESS_LEVEL = SynchedEntityData.defineId(CopepodEntity.class, EntityDataSerializers.INT);
    public CopepodEntity(EntityType<? extends AbstractSchoolingFish> p_30341_, Level p_30342_) {
